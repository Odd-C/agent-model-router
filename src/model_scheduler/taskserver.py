...
def make_handler(app: TaskDashboardApp) -> type[BaseHTTPRequestHandler]:
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        server_version = "model-scheduler-taskserver/0.3.0"
...
<div class="container">
  <header class="page-header">
    ...
    <p>机会型调度：利用空闲资源窗口执行非紧急任务。版本 0.3.0</p>
  </header>
  ...
  <div class="footer">model-scheduler v0.3.0 · Opportunistic Scheduling dashboard · no external resources</div>
</div>
